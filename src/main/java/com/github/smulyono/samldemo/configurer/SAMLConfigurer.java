package com.github.smulyono.samldemo.configurer;
...
/*
 Taken from
 https://raw.githubusercontent.com/spring-projects/spring-security-saml-dsl/1.0.5.RELEASE/core/src/main/java/org/springframework/security/extensions/saml2/config/SAMLConfigurer.java

 Since the configurer has `private` constructor, unable to extend the class
*/
public class SAMLConfigurer extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    public SAMLConfigurer successHandler(AuthenticationSuccessHandler samlAuthenticationSuccessHandler) {
        this.samlAuthenticationSuccessHandler = samlAuthenticationSuccessHandler;
        return this;
    }

    public SAMLConfigurer failureHandler(AuthenticationFailureHandler samlAuthenticationFailureHadler) {
        this.samlAuthenticationFailureHandler = samlAuthenticationFailureHadler;
        return this;
    }
    ...
    private SAMLProcessingFilter samlWebSSOProcessingFilter(SAMLAuthenticationProvider samlAuthenticationProvider, SAMLContextProvider contextProvider, SAMLProcessor samlProcessor) throws Exception {
        ...
        // attach success and failure handler
        if (null != this.samlAuthenticationSuccessHandler) {
            samlWebSSOProcessingFilter.setAuthenticationSuccessHandler(this.samlAuthenticationSuccessHandler);
        }
        if (null != this.samlAuthenticationFailureHandler) {
            samlWebSSOProcessingFilter.setAuthenticationFailureHandler(this.samlAuthenticationFailureHandler);
        }
